...
function createDebugOverlay(id: BuildingVisualId, sprite: Sprite): Container {
  ...
  const geometry = new Graphics()
    ...
    .moveTo(visuals.statusStackAnchor.x - 5, visuals.statusStackAnchor.y)
    .lineTo(visuals.statusStackAnchor.x + 5, visuals.statusStackAnchor.y)
    .moveTo(visuals.statusStackAnchor.x, visuals.statusStackAnchor.y - 5)
    .lineTo(visuals.statusStackAnchor.x, visuals.statusStackAnchor.y + 5)
