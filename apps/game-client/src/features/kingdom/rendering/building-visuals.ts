...
export interface BuildingVisualDefinition {
  ...
  upgradeIndicatorAnchor: PointData;
  levelBadgeAnchor: PointData;
}
...
export const BUILDING_VISUALS: Readonly<Record<BuildingVisualId, BuildingVisualDefinition>> = {
  castle: {
    ...
    hitArea: { x: 0, y: -30, width: 225, height: 205 }, upgradeIndicatorAnchor: { x: 76, y: -148 }, levelBadgeAnchor: { x: 0, y: 0 },
  },
  farm: {
    ...
    hitArea: { x: 0, y: -37, width: 172, height: 118 }, upgradeIndicatorAnchor: { x: 70, y: -100 }, levelBadgeAnchor: { x: 68, y: -88 },
  },
  lumberMill: {
    ...
    hitArea: { x: 0, y: -39, width: 170, height: 118 }, upgradeIndicatorAnchor: { x: 66, y: -103 }, levelBadgeAnchor: { x: 66, y: -90 },
  },
  mine: {
    ...
    hitArea: { x: -8, y: -78, width: 178, height: 166 }, upgradeIndicatorAnchor: { x: 68, y: -116 }, levelBadgeAnchor: { x: 66, y: -104 },
  },
  grandMarket: {
    ...
    hitArea: { x: 0, y: -48, width: 190, height: 138 }, upgradeIndicatorAnchor: { x: 74, y: -116 }, levelBadgeAnchor: { x: 74, y: -102 },
  },
  barracks: {
    ...
    hitArea: { x: 0, y: -46, width: 190, height: 138 }, upgradeIndicatorAnchor: { x: 74, y: -117 }, levelBadgeAnchor: { x: 76, y: -105 },
  },
  blacksmith: {
    ...
    hitArea: { x: -1, y: -45, width: 170, height: 132 }, upgradeIndicatorAnchor: { x: 61, y: -116 }, levelBadgeAnchor: { x: 63, y: -103 },
  },
  academy: {
    ...
    hitArea: { x: 0, y: -54, width: 178, height: 148 }, upgradeIndicatorAnchor: { x: 64, y: -137 }, levelBadgeAnchor: { x: 67, y: -123 },
  },
  granary: {
    ...
    hitArea: { x: 0, y: -43, width: 174, height: 126 }, upgradeIndicatorAnchor: { x: 65, y: -109 }, levelBadgeAnchor: { x: 67, y: -96 },
  },
  watchtower: {
    ...
    hitArea: { x: 0, y: -64, width: 132, height: 176 }, upgradeIndicatorAnchor: { x: 45, y: -157 }, levelBadgeAnchor: { x: 47, y: -145 },
  },
  workshop: {
    ...
    hitArea: { x: 1, y: -43, width: 170, height: 126 }, upgradeIndicatorAnchor: { x: 65, y: -109 }, levelBadgeAnchor: { x: 67, y: -97 },
  },
  stable: {
    ...
    hitArea: { x: 0, y: -40, width: 180, height: 122 }, upgradeIndicatorAnchor: { x: 70, y: -106 }, levelBadgeAnchor: { x: 72, y: -94 },
  },
  tavern: {
    ...
    hitArea: { x: 0, y: -44, width: 170, height: 130 }, upgradeIndicatorAnchor: { x: 64, y: -114 }, levelBadgeAnchor: { x: 66, y: -101 },
  },
};
