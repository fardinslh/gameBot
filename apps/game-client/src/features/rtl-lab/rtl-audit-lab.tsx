import { BidiTemplate, BidiValue, NumberLocaleProvider } from '@/i18n/bidi';
...
export function RtlAuditLab() {
  return (
    <main className={styles.lab} data-rtl-audit="ready">
      ...
      <NumberLocaleProvider locale="fa"><section className={styles.panel} dir="rtl" lang="fa" data-audit-locale="fa">
        <h2>نمونهٔ فارسی</h2>
      ...
      </section></NumberLocaleProvider>

      <NumberLocaleProvider locale="en"><section className={styles.panel} dir="ltr" lang="en" data-audit-locale="en">
