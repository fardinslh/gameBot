...
- **Retention 05 — Shop MVP + Gem Economy**: uncapped earned Gems, three permanent Profile Crests, generic entitlements, and optional authoritative Building/training completion

## Current and next

The **Player Experience repair and Retention 01A, 01B, 02, 03A, 03B, 04, and 05 are complete in engineering**. Retention 05B Kingdom Themes Foundation is next and has not started. Owner visual approval of Shop, Campaign, building, and troop art, Aren approval, audible loop review, and real-device mix remain human checks. Bale Mini App Integration is intentionally delayed until the bounded retention roadmap is complete.
...
First-Party Analytics (complete)
  ...
  -> Retention 05 Shop + Gems (implemented)
  -> Retention 05B Kingdom Themes Foundation + First Historical Theme (next)
...
All nine active buildings, authoritative Kingdom progression goals, Retention 02 return loops, Retention 03 Army/Commander Battle expansion, Retention 04 PvE Campaign, and Retention 05 Shop/Gem economy are implemented. Retention 05B Kingdom Themes Foundation is next; do not start it automatically. New Raid, Revenge, and Campaign attempts use Army Battle rules version 2 while stored Hero rules-version-1 replay remains compatible. See [Shop and Gems](SHOP_AND_GEMS.md), [Army and Commanders](ARMY_AND_COMMANDERS.md), [PvE Campaign](PVE_CAMPAIGN.md), and the [retention roadmap](RETENTION_ROADMAP.md).
...
- Payment design and verified platform commerce
