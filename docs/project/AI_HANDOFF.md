...
Retention work is split into explicit bounded tasks. Retention 03A, 03B, 04, 05, and Phase A Engagement Cohesion are complete; do not automatically start Retention 05B Themes, Guild, Leaderboards, Bale, Telegram, Barracks activation, equipment, or new building gameplay.
