...
| `npm run validate:kingdom-soul` | Unit coverage including cold-load reduced-motion return completion, plus identity defaults/update/persistence, Castle milestones through level 20, building activity/construction, active-Formation Hero homes, combined 14-actor cap, hidden-page pause, reduced motion, Persian/English 320/375/390, navigation, overflow, screenshots, and browser console |
