...
| `npm run validate:kingdom-soul` | Identity defaults/update/persistence, Castle current/next/future transformation projection, six-to-ten actor budget, reduced motion, Persian/English 320/375/390, 54px navigation, overflow, screenshots, and browser console |
