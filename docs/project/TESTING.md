...
| `npm run validate:economy-hud` | Controlled four-column `current / capacity` grid, separate centered Gem pill, equal widths, hourly production/full states, no legacy Live/overflow wording, capacity-aware Collect, exact count-up, reduced motion, Persian/English 320/375/390, screenshots, layout, and browser console |
