...
| `npm run validate:economy-hud` | Controlled `current / capacity`, hourly production/full states, no legacy Live/overflow wording, capacity-aware Collect, exact count-up, reduced motion, Persian/English 320/375/390, screenshots, layout, and browser console |
