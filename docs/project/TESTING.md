...
| `npm run validate:kingdom-soul` | Unit coverage including cold-load reduced-motion return completion and victory-only return loot, plus identity defaults/update/persistence, Castle milestones through level 20, building activity/construction, active-Formation grounded Hero homes/assets, combined 14-actor cap, hidden-page pause, reduced motion, Persian/English 320/375/390, navigation, overflow, screenshots, and browser console |
