...
| --- | --- |
| `npm test` | 27 unit tests in 8 files: economy math/config, Hero math, battle engine, DTOs, Kingdom XP/effects/expansion |
| `npm run test:integration` | 33 tests in 3 files: economy, Heroes, Raid, Revenge, transactions, ownership, retries, concurrency |
...
| `npm run validate:raid` | Match Offer, victory and defeat, Pixi playback, snapshots/events, settlement, Kingdom HUD refresh, mobile locales |
